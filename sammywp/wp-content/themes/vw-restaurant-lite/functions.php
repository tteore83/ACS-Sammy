...
function vw_restaurant_lite_scripts() {
	...
	wp_enqueue_script( 'vw-restaurant-lite-custom-jquery', esc_url(get_template_directory_uri()) . '/js/custom.js', array('jquery') );
...
function vw_restaurant_lite_tagline_hide_show(){
	if(get_theme_mod('vw_restaurant_lite_tagline_hide_show') == '1' ) {
		return true;
	}
	return false;
}
