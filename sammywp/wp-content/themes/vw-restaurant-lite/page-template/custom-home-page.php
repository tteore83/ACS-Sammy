...
<main id="maincontent" role="main">
  ...
  <?php if( get_theme_mod( 'vw_restaurant_lite_slider_hide_show', false) != '' || get_theme_mod( 'vw_restaurant_lite_resp_slider_hide_show', false) != '') { ?>
            ...
            <div <?php if($i == 1){echo 'class="carousel-item active"';} else{ echo 'class="carousel-item"';}?>>
              ...
              <div class="carousel-caption">
                <div class="inner_carousel">
                  <?php if( get_theme_mod('vw_restaurant_lite_slider_title_hide_show',true) != ''){ ?>
                    <h1><a href="<?php echo esc_url( get_permalink() ); ?>" title="<?php echo the_title_attribute(); ?>"><?php the_title(); ?></a></h1>
                  <?php } ?>
                  <?php if( get_theme_mod('vw_restaurant_lite_slider_content_hide_show',true) != ''){ ?>
                  ...
                  <?php } ?>
                  <?php if( get_theme_mod('vw_restaurant_lite_slider_button_hide_show',true) != ''){ ?>
