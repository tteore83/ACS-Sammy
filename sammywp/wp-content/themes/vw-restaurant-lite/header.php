...
<header role="banner">
  ...
  <?php if( get_theme_mod( 'vw_restaurant_lite_topbar_hide_show', false) != '' || get_theme_mod( 'vw_restaurant_lite_resp_topbar_hide_show', false) != '') { ?>
    <div class="topheader">
      <div class="container">
        <div class="row">
  ...
  <?php } ?>
   <div class="header <?php if( get_theme_mod( 'vw_restaurant_lite_sticky_header', false) != '' || get_theme_mod( 'vw_restaurant_lite_stickyheader_hide_show', false) != '') { ?> header-sticky"<?php } else { ?>close-sticky <?php } ?>">
    <div class="container">
      <div class="row">
        ...
        <div class="menubox col-lg-7 col-md-5 col-4 align-self-lg-center">
...
<?php if(get_theme_mod('vw_restaurant_lite_loader_enable',false) != '') { ?>
  <div id="preloader">
