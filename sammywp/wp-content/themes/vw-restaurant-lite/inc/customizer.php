...
function vw_restaurant_lite_customize_register( $wp_customize ) {
  ...
  $wp_customize->add_setting( 'vw_restaurant_lite_toggle_time',array(
    'default' => 1,
    'transport' => 'refresh',
    'sanitize_callback' => 'vw_restaurant_lite_switch_sanitization'
    ) );
    $wp_customize->add_control( new VW_Restaurant_Lite_Toggle_Switch_Custom_Control( $wp_customize, 'vw_restaurant_lite_toggle_time',array(
