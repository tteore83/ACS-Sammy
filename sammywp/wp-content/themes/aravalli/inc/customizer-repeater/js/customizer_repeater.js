        ...
        th.find('.customizer-repeater-general-control-repeater-container').each(function () {
            ...
            if (text !== '' || image_url !== ''  || image_url2 !== '' || title !== '' || subtitle !== '' || icon_value !== '' || link !== '' || choice !== '' || social_repeater !== '' || shortcode !== '' || slide_align !== '' || color !== '') {
                values.push({
                    ...
                    'link': link,
					'button': aravalliescapeHtml(button),
...
jQuery(document).ready(function () {
    ...
    aravalli_theme_controls.on('click', '.customizer-repeater-new-field', function () {
         ...
         if(jQuery('#exist_aravalli_Slider').val()<3)
        {
		 ...
		 if(split_add_more_button_split=="Add New Room")
        {
        if(jQuery('#exist_aravalli_Rooms').val()>=3)
        {
        jQuery(".customizer_room_upgrade_section").show();
        return false;   
        }
         if(jQuery('#exist_aravalli_Rooms').val()<3)
        {
         var new_service_add_val=parseInt(jQuery('#exist_aravalli_Rooms').val())+1;
         jQuery('#exist_aravalli_Rooms').val(new_service_add_val);  
        }
        }
         if(split_add_more_button_split=="Add New Feat")
        {
        if(jQuery('#exist_aravalli_Feature').val()>=4)
        {
        ...
        return false;   
         ...
         if(jQuery('#exist_aravalli_Feature').val()<4)
        {
         var new_service_add_val=parseInt(jQuery('#exist_aravalli_Feature').val())+1;
         jQuery('#exist_aravalli_Feature').val(new_service_add_val);  
        }
        }
		
		if(split_add_more_button_split=="Add New Soci")
        {
        if(jQuery('#exist_aravalli_Social').val()>=4)
        {
        ...
        return false;   
         ...
         if(jQuery('#exist_aravalli_Social').val()<4)
        {
         var new_service_add_val=parseInt(jQuery('#exist_aravalli_Social').val())+1;
         jQuery('#exist_aravalli_Social').val(new_service_add_val);  
        }
        }
		
		if(split_add_more_button_split=="Add New Amen")
        {
        if(jQuery('#exist_aravalli_Amenities').val()>=8)
        {
        jQuery(".customizer_amenities_upgrade_section").show();
        return false;   
        }
         if(jQuery('#exist_aravalli_Amenities').val()<8)
        {
         var new_service_add_val=parseInt(jQuery('#exist_aravalli_Amenities').val())+1;
         jQuery('#exist_aravalli_Amenities').val(new_service_add_val);  
        }
        }
    ...
    aravalli_theme_controls.on('click', '.social-repeater-general-control-remove-field', function () {
        ...
        if (typeof    jQuery(this).parent() !== 'undefined') {
            jQuery(this).parent().hide(500, function(){
				...
				if(split_delete_button_split=="Delete Rooms")
                {
                jQuery('#exist_aravalli_Rooms').val(parseInt(jQuery('#exist_aravalli_Rooms').val())-1);  
                }
				if(split_delete_button_split=="Delete Featu")
                {
                jQuery('#exist_aravalli_Feature').val(parseInt(jQuery('#exist_aravalli_Feature').val())-1); 
                }
				if(split_delete_button_split=="Delete Socia")
                {
                jQuery('#exist_aravalli_Social').val(parseInt(jQuery('#exist_aravalli_Social').val())-1); 
                }
				if(split_delete_button_split=="Delete Ameni")
                {
                jQuery('#exist_aravalli_Amenities').val(parseInt(jQuery('#exist_aravalli_Amenities').val())-1); 
                }
   ...
   aravalli_theme_controls.on('keyup', '.customizer-repeater-button-text-control', function () {
        aravalli_customizer_repeater_refresh_general_control_values();
    });
