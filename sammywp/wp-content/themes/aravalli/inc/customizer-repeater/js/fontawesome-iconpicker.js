(function ($) {
    ...
    wp.aravallicustomizerRepeater = {
        ...
        init: function () {
            $('.iconpicker-items>i').on('click', function () {
                ...
                aravalli_customizer_repeater_refresh_social_icons(th);
                return false;
            });
        },
    ...
    $(document).ready(function () {
        wp.aravallicustomizerRepeater.init();

        $('.iconpicker-search').on('keyup', function () {
            wp.aravallicustomizerRepeater.search($(this));
        });

        $('.icp-auto').on('click', function () {
            wp.aravallicustomizerRepeater.iconPickerToggle($(this));
        });
