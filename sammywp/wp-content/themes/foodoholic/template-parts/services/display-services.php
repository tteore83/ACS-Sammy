...
<?php
$enable_content = get_theme_mod( 'foodoholic_service_option', 'disabled' );
...
$services_posts = foodoholic_get_services_posts();

if ( empty( $services_posts ) ) {
	return;
}

$title    = get_option( 'ect_service_title', esc_html__( 'Services', 'foodoholic' ) );
