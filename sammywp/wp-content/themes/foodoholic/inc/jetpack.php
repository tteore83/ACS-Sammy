 ...
 */
function foodoholic_jetpack_setup() {
	/**
	...
	if ( 'infinite-scroll' === $pagination_type ) {
		add_theme_support( 'infinite-scroll', array(
			...
			'render'    => 'foodoholic_infinite_scroll_render',
			'footer'    => 'page',
			'wrapper'   => false,
		) );
	}
...
add_action( 'after_setup_theme', 'foodoholic_jetpack_setup' );

/**
 * Custom render function for Infinite Scroll.
 */
function foodoholic_infinite_scroll_render() {
	while ( have_posts() ) {
		the_post();
		if ( is_search() ) :
